...
O frontend da aplicação foi desenvolvido com HTML, CSS e JavaScript. Os dados dos filmes são obtidos por meio da API TMDb , enquanto o backend é simulado utilizando uma API Fake com JSON Server para armazenar informações de usuários e interações simples do sistema.
